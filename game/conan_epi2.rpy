...
screen fixed_button:
    frame:
        align (0.9, 0.1) # 화면 오른쪽 상단
        textbutton "map" action Show("map_screen")

screen map_screen:
    # modal True # 맵 화면을 닫을 때까지 다른 조작 불가
    tag menu
    frame:
        align (0.5, 0.5) # 화면 중앙
        vbox:
            add im.Scale("images/scene3.png", 1000, 700)
...
#         # text "화면을 뒤져 지금 있는 곳을 알아내세요" xpos 1500 ypos 200

#     text "화면을 뒤져 지금 있는 곳을 알아내세요" xpos 700 ypos 200
#     textbutton "정답 입력":
#         action ShowMenu("answer_input")
