...
image scene40 = im.Scale("images/scene40.png", 1500, 1080)
image scene41 = im.Scale("images/scene41.png", 1500, 1080)
image scene42 = im.Scale("images/scene42.png", 1500, 1080)
image scene43 = im.Scale("images/scene43.png", 1500, 1080)
image scene44 = im.Scale("images/scene44.png", 1500, 1080)
image scene45 = im.Scale("images/scene45.png", 1500, 1080)
image scene46 = im.Scale("images/scene46.png", 1500, 1080)
image scene47 = im.Scale("images/scene47.png", 1500, 1080)
image scene48 = im.Scale("images/scene48.png", 1500, 1080)
image scene49 = im.Scale("images/scene49.png", 1500, 1080)
image scene50 = im.Scale("images/scene50.png", 1500, 1080)
image scene51 = im.Scale("images/scene51.png", 1500, 1080)
image scene52 = im.Scale("images/scene52.png", 1500, 1080)
image scene53 = im.Scale("images/scene53.png", 1500, 1080)
image scene54 = im.Scale("images/scene54.png", 1500, 1080)
image scene55 = im.Scale("images/scene55.png", 1500, 1080)
image scene56 = im.Scale("images/scene56.png", 1500, 1080)
image scene57 = im.Scale("images/scene57.png", 1500, 1080)
image scene58 = im.Scale("images/scene58.png", 1500, 1080)
image scene59 = im.Scale("images/scene59.png", 1500, 1080)
image scene60 = im.Scale("images/scene60.png", 1500, 1080)
image scene61 = im.Scale("images/scene61.png", 1500, 1080)
image scene62 = im.Scale("images/scene62.png", 1500, 1080)
image scene63 = im.Scale("images/scene63.png", 1500, 1080)
image scene64 = im.Scale("images/scene64.png", 1500, 1080)
image scene65 = im.Scale("images/scene65.png", 1500, 1080)
image scene66 = im.Scale("images/scene66.png", 1500, 1080)
image scene67 = im.Scale("images/scene67.png", 1500, 1080)
image scene68 = im.Scale("images/scene68.png", 1500, 1080)
image scene69 = im.Scale("images/scene69.png", 1500, 1080)
image scene70 = im.Scale("images/scene70.png", 1500, 1080)
image scene71 = im.Scale("images/scene71.png", 1500, 1080)
image scene72 = im.Scale("images/scene72.png", 1500, 1080)
image scene73 = im.Scale("images/scene73.png", 1500, 1080)
image scene74 = im.Scale("images/scene74.png", 1500, 1080)
image scene75 = im.Scale("images/scene75.png", 1500, 1080)
image scene76 = im.Scale("images/scene76.png", 1500, 1080)
image scene77 = im.Scale("images/scene77.png", 1500, 1080)
image scene78 = im.Scale("images/scene78.png", 1500, 1080)
image scene79 = im.Scale("images/scene79.png", 1500, 1080)
image scene80 = im.Scale("images/scene80.png", 1500, 1080)
image scene81 = im.Scale("images/scene81.png", 1500, 1080)
image scene82 = im.Scale("images/scene82.png", 1500, 1080)
image scene83 = im.Scale("images/scene83.png", 1500, 1080)
image scene84 = im.Scale("images/scene84.png", 1500, 1080)
image scene85 = im.Scale("images/scene85.png", 1500, 1080)
image scene86 = im.Scale("images/scene86.png", 1500, 1080)
image scene87 = im.Scale("images/scene87.png", 1500, 1080)
image scene88 = im.Scale("images/scene88.png", 1500, 1080)
image scene89 = im.Scale("images/scene89.png", 1500, 1080)
image scene90 = im.Scale("images/scene90.png", 1500, 1080)
image scene91 = im.Scale("images/scene91.png", 1500, 1080)
image scene92 = im.Scale("images/scene92.png", 1500, 1080)
image scene93 = im.Scale("images/scene93.png", 1500, 1080)
...
label double_headed_arrow:
    ...
    conan "(부러진 지 얼마 안 됐어)"
    conan "(이건 뭔가 날카로운 물건으로 쳐서 부러트린 흔적이야)"
    ...
    show scene40 with fade
    conan "(삽?)"
    conan "(그렇구나 그 사람들이 여기 온 거야)"
    
    show scene41 with fade
    genta "뭐라고 적혀 있는 거지?"
    mitsuhiko "무슨 암호 같은데 읽을 수가 없어"
    show scene42
    ayumi "그렇지!"
    ayumi "이런 건 위에 종이를 대고 연필로 문지르면"
    ayumi "글자가 나타나잖아"
    mitsuhiko "그렇구나"
    show scene43
    ayumi"하지만 종이와 연필을 안 가져왔어"
    mitsuhiko "사인펜이라면 가지고 있는데"
    conan"그거, 쓸 수 있겠다"
    mitsuhiko "이거 말이야?"
    ...
    show scene45 with fade
    conan "우선 물통의 물을 간판에 뿌려"
    show scene46
    conan "그리고 간판의 글자 부분에 흙을 문지르고"
    conan "남은 흙을 치우면..."
    show scene47 with fade
    conan "자, 글자의 틈새에 흙이 껴서 암호를 읽을 수 있지?"
    conan "태양의 바늘"
    conan "시간과 함께 바늘이 가리키는 동쪽으로 가라"
    
    show scene48 with fade
    ayumi "근데 동쪽이 어디야?"
    mitsuhiko "글쎄"
    genta "여긴 그루터기도 없어"
    
    show scene49 with fade
    conan "잠깐만"
    ayumi "왜 그래, 코난?"
    show scene50
...
label bears_hill:
    ...
    show scene61 with fade
    ayumi"하늘의 물이 뭐지?"
    genta "비 아닐까?"
    mitsuhiko "그건 너무 단순하잖아"
    genta"역시 그렇지"

    show scene62 with fade
    conan "돌기둥 5개 돌은 이걸 가리키는 걸 테고"
    ...
    genta "왜 그래, 미츠히코?"
    mitsuhiko "여기야, 여기"
    show scene70 with fade
    mitsuhiko "아파라"
    mitsuhiko "나무에 걸려 넘어졌는데"
    show scene71 with fade
    mitsuhiko "그러고 나서 저 돌에 머리를 부딪혔어"
    conan "나무랑 돌?"

    show scene72 with fade
    conan "(오랫동안 옮긴 흔적이 없어)"
    conan "이건.."
    ...
    conan "(그렇구나)"
    conan "(큰곰자리는 국자 모양이니까 하늘의 물이란 거야)"
    conan "그렇다면.."
    ...
    show scene76 with fade
    conan "북극성은 북두칠성 끝에 있는 두 별 사이의 길이를"
    conan "약 5배 늘린 곳에 있어"
...
label find_polaris:
    ...
    show scene79 with fade
    conan"역시 있었구나"
    conan "(북극성은 폴라리스니까 첫 번째 알파벳 P인가)"
    conan "여기야, 여기가 확실해"
    ...
    show scene83 with fade
    conan "좋았어 가자"
    conan "그래"

    show scene84 with fade
    ayumi "코난, 이건.."
    mitsuhiko "분명 보물일 거야"
    genta"얼른 열어봐, 코난"

    show scene85 with fade
    conan "(설마 이 보석은...)"
    genta "해냈어, 미츠히코"
    ...
    show scene89 with fade
    mitsuhiko"설마 이게 보물이야?"
    genta"이런 종이 쪼가리 한 장이?"
    ayumi"코난, 뭐라고 적혀 있어?"
...
label go_to_the_place:
    ...
    show scene93 with fade
    "상황 파악을 하신 박사님이 바로 경찰에 연락해서"
    "보석 강도 일당은 체포되었고"

    show scene94 with fade
    "우리의 조사는 다음 날로 미뤄져서 그날은 풀려났다"
